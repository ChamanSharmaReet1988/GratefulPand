...
class VisionSettings extends StatefulWidget {
  const VisionSettings({super.key});

  @override
  State<VisionSettings> createState() => _VisionSettingsState();
}

class _VisionSettingsState extends State<VisionSettings> {
